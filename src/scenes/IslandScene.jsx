...
import Loading from "./GameUI/Loading";

import OrthographicTopDownScene from "./utils/OrthographicTopDownScene";
    ...
    <>
      ...
      <Suspense fallback={<Loading />}>
        <div style={{ position: "relative", width: "100vw", height: "100vh" }}>
          {/* Main Canvas */}
          <Canvas
            style={{ width: "100%", height: "100%", background: "#72badb" }}
            gl={{ shadows: true }}
            camera={{
          ...
          {/* Top-Down Orthographic Canvas Overlay */}
          <Canvas
            style={{
              position: "absolute",
              bottom: 20,

...
export default function Large_road(props) {
  const { nodes, materials } = useGLTF('/models/environment_models/Large road.glb')
  return (
...
useGLTF.preload('/models/environment_models/Large road.glb')
